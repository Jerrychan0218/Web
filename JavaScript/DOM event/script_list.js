var button1 = document.getElementById("enter"); /*如果只選button，會回傳button的array，所以要選取[0]*/
...
button1.addEventListener("click", addListClick);
input.addEventListener("keypress", addListAfterKeypress);
button2.addEventListener("click,", clearlist);